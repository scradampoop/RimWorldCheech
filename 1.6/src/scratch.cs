...
//public class PawnRenderNode_BodyTypeGraphic(Pawn pawn, PawnRenderNodeProperties props, PawnRenderTree tree): PawnRenderNode(pawn, props, tree)
//{
...
//                return GraphicDatabase.Get<Graphic_Multi>(props.bodyTypeGraphicPaths[index].texturePath, ShaderFor(pawnGraphicFor), Vector2.one, ColorFor(pawnGraphicFor));
//        }
//        return null;
//    }

//    public override Color ColorFor(Pawn pawn) => pawn.story.HairColor;
//}
